...
comment_button = Button(COMMENT_BUTTON_X_POS, COMMENT_BUTTON_Y_POS, COMMENT_BUTTON_WIDTH, COMMENT_BUTTON_HEIGHT)
...
share_button = Button(SHARE_BUTTON_X_POS, SHARE_BUTTON_Y_POS, SHARE_BUTTON_WIDTH, SHARE_BUTTON_HEIGHT)
