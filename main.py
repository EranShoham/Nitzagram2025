...
from helpers import screen, mouse_in_button, read_comment_from_user, censor_comments
...
def main():
    ...
    posts = [
        ImagePost("Noa Kirel", "Tel-Aviv, Israel", "Ani Panthera!", "Images/noa_kirel.jpg"),
        ...
        ImagePost("ShelegTheCat", "Be'er-Sheva, Israel", "Alone time is the best...", "Images/Sheleg.jpg",
                  purple_filter),
        ImagePost("TotoThePuppy", "Be'er-Sheva, Israel", "Doggy life!", "Images/Toto.jpg", brown_filter),
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if mouse_in_button(like_button, mouse_pos):
                    ...
                    comment_text = censor_comments(read_comment_from_user())
